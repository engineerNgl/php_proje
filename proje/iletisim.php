...
$sorgu=$baglanti->prepare(query:"insert into iletisim set ad=:ad, email=:email, mesaj=:mesaj");
 $ekle=$sorgu->execute(
...
'email'=>htmlspecialchars($_POST["txtEmail"]),
  'mesaj'=>htmlspecialchars($_POST["txtMesaj"]),
    ...
    $mail->Host     = "mail.nn.com"; //SMTP server adresi  
    $mail->SMTPAuth = true;
    $mail->Username = "deneme@nn.com"; //SMTP kullanıcı adı  
...
if(mailgonder()) echo echo "<script>Swal.fire({  title:'Başarılı!' , text:'Mesajınız iletildi ' , icon:'success' ,confirmButtonText:'Tamam' } ) </script>";


else echo echo "<script> Swal.fire('Hata!' , 'Tüm Alanları Doğru Doldurun ' , 'error') </script>";  
     ...
     */     
         ...
         echo "<script>Swal.fire({  title:'Başarılı!' , text:'Mesajınız iletildi ' , icon:'success' ,confirmButtonText:'Tamam' } ) </script>"; }
