...
$sorgu=$baglanti->prepare(query:"select kadi,yetki from kullanici where aktif=1");
 ...
 if($_COOKIE["cerez"]==md5(string: "aa". $sonuc['kadi']."bb")){
...
?>                                    
                                        ...
                                        <form method="post" action="login.php">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" name="txtKadi"  value="<?php echo $kadi?>"  placeholder="Kullanıcı Adı" />
 ...
 setcookie("cerez",md5(string: "aa".$kadi."bb"),time()+(60*60*24*7));
